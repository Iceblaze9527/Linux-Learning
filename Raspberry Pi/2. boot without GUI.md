...
If you have multiple RPi hosts working, then different hostnames should be set to distinguish them. Use `sudo nano /etc/hosts`, and typically you will see a line: ``
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjQyMjIxNDBdfQ==
-->