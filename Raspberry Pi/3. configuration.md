...
Here's a thing for whether to use `sudo apt-get install` or `pip3 install` to get Python packages. We recommend using `sudo apt-get install` as 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUxNzYxMzg1MywtMTg2NjkzMTIxMywtMT
